...
export async function participantsUpdate({ id, participants, action }) {
    ...
    conn.sendButtonDoc(id, text, wm, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : 'Fanz', fkontak, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: "https://www.youtube.com/channel/unknown",
    mediaType: 2, 
    description: "https://www.youtube.com/channel/unknown", 
    title: 'FanzBotzz',
    body: wm,
